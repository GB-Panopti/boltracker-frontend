...
const STOCK_ALL_API_URL = process.env.NEXT_PUBLIC_SERVER_HOST + "/api/stock/getDailySales";
const STOCK_DATERANGE_API_URL = process.env.NEXT_PUBLIC_SERVER_HOST + "/api/stock/getAllDateRange";
...
class StockService {
    ...
    getAllUserStockDateRange(start: Date | undefined, end: Date | undefined) {
        const url = STOCK_DATERANGE_API_URL + "?start=" + start?.toISOString().split('T')[0] + "&end=" + end?.toISOString().split('T')[0];
