...
export const focusInput = [
  ...
  "focus:ring-2",
  // ring color
  "focus:ring-gb-secondary-200 focus:dark:ring-gb-secondary-700/30",
  // border color
  "focus:border-gb-secondary-500 focus:dark:border-gb-secondary-700",
];
...
export const focusRing = [
  ...
  // outline color
  "outline-gb-secondary-500 dark:outline-gb-secondary-500",
];
