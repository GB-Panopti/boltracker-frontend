  ...
  return (
    <Card className="custom-card flex flex-col items-center justify-center">
      <p className="text-gb-default flex justify-between w-full">
        <span className="text-gb-content-strong dark:text-dark-gb-content-strong font-medium">
          example.com
        </span>
        <span className="text-gb-content dark:text-dark-gb-content">
          uptime 99.1%
        </span>
      </p>
      ...
      <p className="w-full">
        <span className="text-gb-content-strong dark:text-dark-gb-content-strong font-medium">
          There have been 3 stock refills in the last 3 months.
        </span>
      </p>
      <br />
      <CategoryBar
