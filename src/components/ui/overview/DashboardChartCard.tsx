...
//       const valrue = (overview?.[value] as number) || null
...
//         evolution:
//           selectedPeriod !== "no-comparison" && valrue && previousValue
//             ? (valrue - previousValue) / previousValue
//             : undefined,
//       }
//     })
//     .sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime())
