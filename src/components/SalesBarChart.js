...
export default function SalesBarChart() {
  ...
  return (
    <Card className="custom-card">
      <h2 className="text-gb-default text-gb-content dark:text-dark-gb-content">
        {selectedItem.name}
      </h2>
      <p className="text-gb-metric text-gb-content-strong dark:text-dark-gb-content-strong font-semibold">
