  ...
  switch (tabVariant) {
    case "line":
      return cx(
        ...
        // selected
        "data-[state=active]:border-gb-secondary-500 data-[state=active]:text-gb-secondary-500",
        "data-[state=active]:dark:border-gb-secondarylite-500 data-[state=active]:dark:text-gb-secondarylite-500",
        // disabled
