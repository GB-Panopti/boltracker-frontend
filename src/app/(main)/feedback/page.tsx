    ...
    <>
      <div className="sm:mx-auto sm:max-w-2xl">
        ...
        <Callout title="Thank you!" color="teal">
          Thank you for taking a moment to let us know what you think! We truly
          appreciate your feedback and will use it to further improve{" "}
          <span className="font-semibold">Panopti</span>.
        </Callout>
          ...
          <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              >
                <SelectItem
                  value="1"
                  className="bg-white dark:bg-[#090E1A] w-full "
                >
                  <div className="flex space-x-1">
                    <RiStarFill className="mt-1 size-4" />
                    <RiStarLine className="mt-1 size-4" />
                    <RiStarLine className="mt-1 size-4" />
                    <RiStarLine className="mt-1 size-4" />
                    <RiStarLine className="mt-1 size-4" />
